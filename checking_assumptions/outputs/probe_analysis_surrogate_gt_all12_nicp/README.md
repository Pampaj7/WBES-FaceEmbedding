# Probe Analysis: surrogate_gt_all12_nicp

Source probe dir: `/deck/datasets/WBES-FaceEmbedding/checking_assumptions/outputs/same_vs_diff_gap_probe_surrogate_gt_all12_nicp`

## clean

- metrics analyzed: `latent_distance, raw_chamfer, rigid_registered_chamfer, nicp_correspondence`
- best metric on different-subject Spearman vs GT: `latent_distance` = `0.7614`
- same pairs: `180`
- different pairs: `300`
...
- metrics analyzed: `latent_distance, raw_chamfer, rigid_registered_chamfer, nicp_correspondence`
- best metric on different-subject Spearman vs GT: `latent_distance` = `0.7567`
- same pairs: `180`
- different pairs: `300`
