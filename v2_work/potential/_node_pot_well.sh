...
exec .conda_env/bin/python v2_work/fastio/train_fast.py \
  ...
  --data_dir v2_work/potential/bfm_withwell --dist_npz face_embedding/gt_encdec/autoencoder/latent_analysis/gt_distance_matrix/normalized_matrix_distances.npz \
  --runs_root v2_work/runs/pot_well_${LSB_JOBID:-local} \
