...
exec .conda_env/bin/python v2_work/fastio/train_fast.py \
  ...
  --runs_root v2_work/runs/abl_intrinsic_${LSB_JOBID:-local} \
  --device cuda \
  ...
  --eval_mode average --eval_every 2 --save_every 5 --seed 1234 --model intrinsic_dn --no-use_xyz --n_hks 16 --n_wks 16 --k_spec 0 --no-log_spec
