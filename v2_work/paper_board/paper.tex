...
$k_{\mathrm{eig}}=128$ takes approximately 1.2--2.15 s for 16.5k--23.5k vertex
meshes and 6.3 s for 60.4k-vertex upsampled meshes; encoding is then performed
once per mesh. For the full REMESH benchmark of 3,000 meshes, preprocessing is a
one-time cost of hours serially or tens of minutes with modest parallelization.
Thus, the expensive part scales linearly in the number of meshes and is
amortized across all pairwise comparisons.
