...
SLICE=$(printf "/dtu/p1/leopam/WBES-FaceEmbedding/v2_work/cluster/_test_out/.slices/task%03d" $LSB_JOBINDEX)
exec .conda_env/bin/python face_embedding/gt_encdec/autoencoder/precompute_operators_npz.py \
    --input-dir "$SLICE" --output-dir "/dtu/p1/leopam/WBES-FaceEmbedding/v2_work/cluster/_test_out" --k-eig 128 --n-cores 4
