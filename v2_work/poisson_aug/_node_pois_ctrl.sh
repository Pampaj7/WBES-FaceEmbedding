...
exec .conda_env/bin/python v2_work/fastio/train_fast.py \
  ...
  --data_dir v2_work/genflame/flame_train_ready/npz_withops --dist_npz v2_work/genflame/flame_train_ready/gt_matrix.npz \
  --runs_root v2_work/runs/pois_ctrl_${LSB_JOBID:-local} \
